...
public class SchaffersEvaluation implements ContestEvaluation {
    ...
    private static final double BASE_ = -13.35288;
    ...
    public SchaffersEvaluation() {
        ...
        this.function_.initBBOB(17, 1, 10, "tmp", params);
    ...
    public Object evaluate(Object object) {
        ...
        double d = (this.function_.evaluate(arrd) - this.target_) / (-13.35288 - this.target_);
