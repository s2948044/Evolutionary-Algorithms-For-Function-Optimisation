...
class cma_es:
    ...
    def __init__(self, make="mingw32-make"):
        self._evaluations = ["BentCigarFunction", "KatsuuraEvaluation", "SchaffersEvaluation"]
        self._make = make
    ...
    def geno_to_pheno(self, solution):
        ...
        for i in range(self.dimension):
            probs[i] = abs(solution[i]) / prob_sum
        return probs
...
class individual:
    ...
    def __init__(self, cma_es):
        self._x = np.empty(shape=[1, cma_es.dimension], dtype=np.float32)
